        ...
        <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 6px 18px rgba(10,37,90,0.08);">
          ...
          <tr>
            <td style="padding:36px 48px 24px;color:#0f172a;">
              ...
              <p style="margin:0 0 20px;color:#475569;line-height:1.5;">We received a request to reset the password for your account. Click the button below to choose a new password. This link is valid for a limited time.</p>

              <p style="text-align:center;margin:28px 0;">
                <a href="{{ $url }}" target="_blank" style="background:#1760ff;color:#fff;padding:14px 28px;border-radius:10px;display:inline-block;text-decoration:none;font-weight:600;">Reset Password</a>
              </p>

              <p style="margin:0 0 8px;color:#94a3b8;font-size:13px;">If you did not request a password reset, no further action is required.</p>
          ...
          <tr>
            <td style="padding:18px 48px 28px;color:#9aa6b2;font-size:12px;border-top:1px solid #eef2f7;">
              <p style="margin:0 0 8px;word-break:break-all;">If you're having trouble clicking the "Reset Password" button, copy and paste the URL below into your web browser:</p>
