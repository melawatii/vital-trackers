{{-- ============================================================ --}}
{{-- DataTable Actions Partial – Vital Records                  --}}
{{-- Renders view, edit, and delete buttons for each row.      --}}
{{-- ============================================================ --}}
...
<div style="display:flex;align-items:center;justify-content:flex-start;gap:6px;padding-right:4px">
    ...
    {{-- View button --}}
    <a href="{{ $showUrl }}"
       style="width:30px;height:30px;border-radius:8px;border:1.5px solid #bae6fd;background:#f0f9ff;color:#0284c7;display:flex;align-items:center;justify-content:center;text-decoration:none;transition:all .15s"
